...
const translations = {
  ...
  // ---- Messaging ----
  'msg.support': { en: 'Support', fr: 'Assistance' },
  'msg.supportTag': { en: 'SUPPORT', fr: 'ASSIST.' },
  'msg.supportSubtitle': { en: 'We usually reply within a day', fr: 'Nous répondons généralement sous un jour' },
  'msg.supportThread': { en: 'Support request', fr: "Demande d'assistance" },
  'msg.conversation': { en: 'Conversation', fr: 'Conversation' },
  'msg.staffBadge': { en: 'Team', fr: 'Équipe' },
  'msg.writePlaceholder': { en: 'Write a message...', fr: 'Écrivez un message...' },
  'msg.noMessages': { en: 'No messages yet', fr: 'Aucun message' },
  'msg.supportHint': { en: 'Send us a message and someone from the church team will get back to you.', fr: "Envoyez-nous un message et un membre de l'équipe vous répondra." },
  ...
  'msg.noConversationsHint': { en: 'Support requests from members will appear here', fr: "Les demandes des membres apparaîtront ici" },
  'msg.noMessagesYet': { en: 'No messages yet', fr: 'Aucun message' },
  'msg.roleStaff': { en: 'Church team', fr: "Équipe de l'église" },
  'msg.roleMember': { en: 'Member', fr: 'Membre' },
