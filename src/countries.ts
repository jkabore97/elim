// International dial codes keyed by the exact English country name used in the
// COUNTRIES list (src/App.tsx). This lets the signup form derive the phone
// country code straight from the country the member selects — they never pick
// a code by hand. Keep the keys byte-identical to COUNTRIES.
export const DIAL_BY_COUNTRY: Record<string, string> = {
  ...
  'Colombia': '+57', 'Comoros': '+269', 'Congo (Brazzaville)': '+242', 'Costa Rica': '+506',
...
// The dial code for a country name, or a fallback when it is unknown.
export function dialFor(country: string, fallback = '+226'): string {
  return DIAL_BY_COUNTRY[country] || fallback
}
